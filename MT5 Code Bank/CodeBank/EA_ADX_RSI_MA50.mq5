...
// Trading
const int MAGIC_NUMBER = 20251015;
...
// Filtre horaire (optionnel, mettre false pour désactiver)
...
int OnInit()
{
    ...
    Print("Risque normal: ", RISK_PERCENT_NORMAL, "% | Risque élevé: ", RISK_PERCENT_HIGH, "%");
...
void OnTick()
{
   if(USE_TRAILING) TrailingStop();
    ...
    if(USE_TIME_FILTER && !IsTimeToTrade()) return;
